<?php
$link = mysqli_connect('127.0.0.1', 'root', 'root', 'sa.yeticave');
...
$sql = "SELECT * FROM lot WHERE `id` = '$lot_id'";
            ...
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="<?=$lot[0]['img_url']?>" width="730" height="548" alt="Сноуборд">
                    </div>
                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__cost-state">
                            <div class="lot-item__rate">
                                ...
                                <span class="lot-item__cost"><?=$lot[0]['price']?></span>
                            </div>
                            <div class="lot-item__min-cost">
                                Мин. ставка <span> <?=$lot[0]['price']?>р</span>
                            </div>
                        </div>
